...
def parse_args():
    ...
    parser.add_argument('--epoch', type=int, default=1000, help='The number of epochs to run') # here is epochs,
    parser.add_argument('--iteration', type=int, default=10000, help='The number of training iterations') # if you dataset is small to put large number like 10,000
    ...
    parser.add_argument('--gan_type', type=str, default='hinge', help='[gan / lsgan / wgan-gp / wgan-lp / dragan / hinge]') # here you can different loss function
    ...
    parser.add_argument('--checkpoint_dir', type=str, default='checkpoint',
                        help='Directory name to save the checkpoints') # folder name "checkpoint" where all checkpoint saved, if training will destroy, and you rerun again where they stopped, the code check if any checkpoint exists, if exists they run from here automatically wher they stopped
    parser.add_argument('--result_dir', type=str, default='results',
                        help='Directory name to save the generated images')
    parser.add_argument('--log_dir', type=str, default='logs',
                        help='Directory name to save training logs') # log folder where you can see the logs
    parser.add_argument('--sample_dir', type=str, default='samples',
                        help='Directory name to save the samples on training') # samples folder, where you can see the generated images
